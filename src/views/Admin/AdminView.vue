...
<div class="flex items-center justify-center h-screen scroll-auto overflow-hidden">
  <div class="flex border border-gray-300 rounded-lg shadow w-full h-3/4 ">
    <div class="flex flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 w-1/2">
      <div class="mx-auto w-full max-w-sm lg:w-96">
        ...
        <div class="pt-8">
          <div>
            <form action="#" method="POST" class="flex flex-col gap-y-6 space-y-6">
              <div>
